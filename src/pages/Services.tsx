...
const dataAnalysisServices = [
  {
    ...
    description: 'Advanced statistical methods to uncover patterns and trends in your data.',
    features: ['Regression Analysis', 'Hypothesis Testing', 'Time Series Analysis']
  },
  {
    icon: TrendingUp,
    title: 'Data Visualization',
    description: 'Transform complex data into clear, interactive visualizations and dashboards.',
    features: ['Interactive Dashboards', 'Custom Charts', 'Business Intelligence']
  },
  {
    icon: Database,
    title: 'Predictive Modeling',
    description: 'Build machine learning models to forecast trends and make data-driven predictions.',
